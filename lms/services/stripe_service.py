...
class StripeService:
    ...
    def create_price(self, product_id: str, unit_amount: int, currency: str = 'usd') -> Dict:
        """
    ...
    def create_payment_link_session(self, course_id: str, price_id: str, success_url: str, cancel_url: str) -> Dict:
        """
